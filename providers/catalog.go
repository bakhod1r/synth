...
func init() {
	...
	set(schema.KindFruit, []string{"Apple", "Banana", "Orange", "Grape", "Mango", "Strawberry", "Pineapple", "Watermelon", "Peach", "Cherry", "Pomegranate"})
	set(schema.KindVegetable, []string{"Carrot", "Potato", "Tomato", "Cucumber", "Onion", "Pepper", "Broccoli", "Spinach", "Eggplant", "Cabbage"})
	set(schema.KindDrink, []string{"Coffee", "Tea", "Water", "Juice", "Cola", "Beer", "Wine", "Lemonade", "Smoothie", "Ayran"})
